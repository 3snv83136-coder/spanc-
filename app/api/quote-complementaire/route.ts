...
<p style="margin-top:18px">Cordialement,<br><strong>${tn}</strong><br>Spécialiste SPANC</p>
</td></tr>
...
<p style="font-size:13px;color:#64748b">Merci,<br><strong>${tn}</strong> — Spécialiste SPANC</p>
</div></body></html>`
}
