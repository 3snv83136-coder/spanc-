...
async function main() {
  ...
  console.log('Opening /...')
  await page.goto('https://app-spanc.vercel.app/', { waitUntil: 'networkidle', timeout: 30000 })
  ...
  const brandText = await page.locator('h1:has-text("SPANC")').isVisible().catch(() => false)

  console.log('SPANC h1 visible:', brandText)
