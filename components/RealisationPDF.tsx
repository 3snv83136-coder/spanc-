...
const Header = ({ phone }: { phone?: string }) => (
  <View style={s.headerTop} fixed>
    <View style={s.brandRow}>
      <Text style={s.brandName}>SPANC</Text>
      <Text style={s.brandTag}>SPANC · Diagnostic ANC · Contrôle · Réhabilitation</Text>
    </View>
  ...
  <View style={s.footer} fixed>
    <View>
      <Text style={s.footerL}>
        Spécialiste SPANC · Intervention et assainissement dans le Var
      </Text>
      <Text style={s.footerL}>
        Tél. 07 83 63 68 35 · contact@votre-domaine-spanc.fr · www.votre-domaine-spanc.fr
      </Text>
    </View>
...
export function RealisationDocument({
  ...
  const ref = reference || rapport.reference || `SPANC-${dateIntervention.replace(/-/g, '')}`
        ...
        <View style={s.content}>
          ...
          <View style={s.idTable} wrap={false}>
            <View style={s.idRow}>
              ...
              <Text style={s.idValue}>Spécialiste SPANC</Text>
            </View>
            ...
            <View>
              ...
              <View style={s.sigTable} wrap={false}>
                <View style={[s.sigCol, s.sigColSep]}>
                  <Text style={s.sigHead}>SPANC — Technicien intervenant</Text>
      ...
      {rapport.devis && (
        <Page size="A4" style={s.page}>
          ...
          <View style={s.content}>
            ...
            <View style={s.sigTable} wrap={false}>
              <View style={[s.sigCol, s.sigColSep]}>
                <Text style={s.sigHead}>Établi par — SPANC</Text>
                <View style={s.sigBody}>
                  <Text style={s.sigLine}>Nom : {technicienNom || '—'}</Text>
                  <Text style={s.sigLine}>Date : {fmtDateFR(dateIntervention)}</Text>
                  <Text style={s.sigLine}>Signature :</Text>
