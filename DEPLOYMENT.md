...
4. SPANC_PUBLISH_TOKEN from Django backend
...
Replace `[PROJECT_NAME]` with your actual Vercel project name (e.g., app-spanc).
...
npx vercel env add SPANC_API_URL production
# Paste: https://votre-domaine-spanc.fr

npx vercel env add SPANC_PUBLISH_TOKEN production
...
1. Open the Vercel URL (e.g., https://app-spanc.vercel.app)
...
### SPANC API not responding
- Verify SPANC_PUBLISH_TOKEN matches Django settings
- Check SPANC_API_URL is accessible from Vercel region
